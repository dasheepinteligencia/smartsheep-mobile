...
# Valida tela da visita ainda pendente
maestro test .maestro/visit_assert.yml

# Faz check-in e trata regra de fora do raio
maestro test .maestro/visit_checkin.yml

# Valida tarefas da visita em andamento
maestro test .maestro/visit_tasks.yml

# Abre a primeira tarefa
maestro test .maestro/visit_open_first_task.yml
